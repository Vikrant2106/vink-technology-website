...
function setTheme(themeName) {
  localStorage.setItem("vink_rtl_theme", themeName);
  document.documentElement.className = themeName;
}

// function to toggle between light and dark theme
function toggleTheme() {
  if (localStorage.getItem("vink_rtl_theme") === "theme-dark") {
...
// Immediately invoked function to set the theme on initial load zinka_rtl_theme
(function () {
  if (localStorage.getItem("vink_rtl_theme") === "theme-dark") {
    setTheme("theme-dark");
